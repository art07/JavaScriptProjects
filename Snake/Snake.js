let Snake = function () {
    this.snakeBodyArray = [new FillingCell(3, 1), new FillingCell(2, 1), new FillingCell(1, 1)];
...
Snake.prototype.snakeMove = function () {
    ...
    if (this.direction === "right") {
        newSnakeHead = new FillingCell(snakeHead.column + 1, snakeHead.row);
    } else if (this.direction === "down") {
        newSnakeHead = new FillingCell(snakeHead.column, snakeHead.row + 1);
