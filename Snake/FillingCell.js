let FillingCell = function (column, row) {
    this.column = column;
    this.row = row;
};

FillingCell.prototype.drawHead = function(color, direction) {
...
FillingCell.prototype.drawBodySquare = function (color) {
...
FillingCell.prototype.drawApple = function (color) {
    let centerX = this.column * cellSize + cellSize / 2;
    let centerY = this.row * cellSize + cellSize / 2;
...
FillingCell.prototype.isEqualCells = function (otherBlock) {
